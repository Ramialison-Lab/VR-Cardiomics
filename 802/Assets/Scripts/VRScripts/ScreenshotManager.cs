...
public class ScreenshotManager : MonoBehaviour
{
    ...
    private string uniqueFilename(int width, int height)
    {
        ...
        var filename = string.Format("{0}/screen_{1}x{2}_{3}.PNG", folder, width, height, counter, format.ToString().ToLower());
    ...
    void Update()
    {
        ...
        captureScreenshot |= OVRInput.GetUp(OVRInput.Button.SecondaryThumbstick);
